...
public class Level_3_4 extends PlayScreen implements Screen{
	...
	public Level_3_4(GazeintoAbyss game) {
		super();
		...
		map = mapLoader.load("Resources/Levels/Level 3/Level 3,4.tmx");
